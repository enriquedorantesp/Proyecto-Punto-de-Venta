...
<head>
    ...
    <meta name="author" content="Enrique Dorantes" />
    ...
    <footer class="text-center text-white">
        ...
        <div class="container p-4 pb-0">
            ...
            <section class="mb-4">
                ...
                <!-- Instagram -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/antoine.dorantes/" role="button" target="_blank">
                ...
                <!-- Github -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://github.com/enriquedorantesp" role="button" target="_blank">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2023 Copyright:
            <a class="text-white" href="#">enrique.dorantesp@gmail.com</a>
        </div>
        <!-- Copyright -->
    </footer>
